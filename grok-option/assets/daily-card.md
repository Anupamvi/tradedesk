...
|------------|--------------|--------|-----------|----------|
| Buy … | Sell … | 2.70 | +$270 / −$730 | 7 |

- net / frac / Δ / σ / ⚠️ worse-fill / 📦 shares held …
...
| ● | Ticker | Action | Expiry | Buy | Sell | Net | Frac | Long Δ | 1-lot P/L | Why |
|---|--------|--------|--------|-----|------|-----|------|--------|-----------|-----|
| 🔵 |  |  |  |  |  |  |  |  |  |  |

## 🔴 Failed (scanned, no row)

- 🔴 TICKER expiry — structure — reason
