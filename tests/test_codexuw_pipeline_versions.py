...
def test_codex_daily_pipeline_versions_are_locked() -> None:
    expected = {
        ...
        "v4": ("Codex Daily V4", "v4.14-maturity-safe-advisory-risk-20260808"),
    }
    ...
    for key, (name, version) in expected.items():
        ...
        expected_lock = {"v2": "2026-05-21", "v3": "2026-07-19", "v4": "2026-08-08"}[key]
...
def test_pipeline_constants_match_locked_registry() -> None:
    ...
    assert daily_v4.PIPELINE_VERSION_V4 == "v4.14-maturity-safe-advisory-risk-20260808"
