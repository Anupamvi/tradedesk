"""Research-only strangle lane: quote construction and outcome scoring."""
...
def test_strangle_research_only_blocker_is_hard():
    assert "LONG_VOL_RESEARCH_ONLY" in core.hard_review_blockers(
