...
- BRKB: caution (medium) - dated UW EOD debit-spread quote; refresh Schwab chain before entry; live Schwab chain unavailable; keep as visible review row
...
- XLU: supportive (medium) - no objective blocker after structure review
...
- XLB: avoid (medium) - objective blocker remains: signal_premium_below_1000000
- JNJ: supportive (medium) - no objective blocker after structure review
- ADBE: supportive (medium) - no objective blocker after structure review
- MU: avoid (medium) - objective blocker remains: directional_bias_below_0.10
...
- VRT: avoid (medium) - objective blocker remains: live_leg_liquidity_below_100
- XLI: supportive (medium) - no objective blocker after structure review
- MRVL: avoid (medium) - objective blocker remains: directional_bias_below_0.10
- ORCL: avoid (medium) - objective blocker remains: directional_bias_below_0.10
- QQQ: avoid (medium) - objective blocker remains: directional_bias_below_0.10
- BX: supportive (medium) - no objective blocker after structure review
- MSFT: avoid (medium) - objective blocker remains: directional_bias_below_0.10
- CVS: supportive (medium) - no objective blocker after structure review
- IWM: avoid (medium) - objective blocker remains: directional_bias_below_0.10
- INTC: avoid (medium) - objective blocker remains: directional_bias_below_0.10
- WDC: avoid (medium) - objective blocker remains: one_lot_max_loss_above_750; live_quote_width_pct_above_40pct
- AMD: avoid (medium) - objective blocker remains: directional_bias_below_0.10
- CRM: avoid (medium) - objective blocker remains: directional_bias_below_0.10
...
- SNDK: avoid (medium) - objective blocker remains: directional_bias_below_0.10; one_lot_max_loss_above_750
- AAPL: avoid (medium) - objective blocker remains: directional_bias_below_0.10
- NOW: avoid (medium) - objective blocker remains: directional_bias_below_0.10
